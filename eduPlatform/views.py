...
from .forms import UserForm, SyllabusDownloadForm, TrainerDataForm, freeDemoForm, UserFullCourseRegistrationForm,UserMiniCourseRegistrationForm,UserPersonalDevelopmentCourseRegistrationForm,userQueryForm
